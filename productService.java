...
public class productService {
    ...
    public static void addproduct() {
        ...
        String name = productDetails.sc.nextLine();

        System.out.println("enter product amount");
        double amount = productDetails.sc.nextDouble();
        productDetails.sc.nextLine();

        System.out.println("enter Product Rating");
        double rating = productDetails.sc.nextDouble();
        productDetails.sc.nextLine();
    ...
    public static void updateProduct() {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(file));
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                int option = productDetails.sc.nextInt();
                productDetails.sc.nextLine();
